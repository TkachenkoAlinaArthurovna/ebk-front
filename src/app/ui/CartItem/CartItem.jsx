    ...
    <Box mt={3}>
      <Box sx={{ display: 'flex', width: '100%', justifyContent: 'space-between' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <StyledImageWrapper>
            <Image src="/images/city-e-bike.jpg" alt="item-preview" width={60} height={40}></Image>
          </StyledImageWrapper>
          <Box>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: '45px' }}>
          <StyledButtonGroup>
            <StyledButton variant="text" onClick={handleDecrement} disabled={count === 1}>-</StyledButton>
            <PageText>{count}</PageText>
            <StyledButton variant="text" onClick={handleIncrement}>+</StyledButton>
          </StyledButtonGroup>
          <Box>
      ...
      <Box sx={{ my: '24px', display: 'flex', justifyContent: 'flex-end', width: '100%' }}>
        <StyledButton>
