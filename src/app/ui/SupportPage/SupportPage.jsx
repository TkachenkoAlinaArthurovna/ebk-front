    ...
    <WrapperSupport>
      ...
      <Box sx={{ marginBottom: '32px' }}>
        ...
        <Typography variant="body1" sx={{ marginBottom: '32px' }}>
          ...
          протягом 14 днів від дати придбання. УВАГА! Якщо при замовленні в
          представлену модель вносяться корективи ( заміна комплектуючих
          велосипеда ), даний велосипед не підлягає поверненню! Ви можете
          повернути товар, якщо дотримано наступних умов:
        </Typography>
        <WrapperConditions>
          <ShadowBox>
            <Box
