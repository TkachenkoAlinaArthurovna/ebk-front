      ...
      <WrapperSupport>
        <Box sx={{ marginBottom: '32px' }}>
          ...
          <Typography variant="body1" sx={{ marginBottom: '32px' }}>
            ...
            споживач має право обміняти товар ненадлежної якості протягом 14
          ...
          <Typography variant="body1" sx={{ marginBottom: '32px' }}>
            ...
            повернення товару ненадлежної якості протягом 14 днів з моменту
          ...
          <Typography variant="body1" sx={{ marginBottom: '32px' }}>
            ...
            сплатжених за товар, або вимагати відправлення товару повторно.
          </Typography>
          <Typography variant="body1" sx={{ marginBottom: '32px' }}>
          ...
          <Typography variant="body1">
            ...
            споживач має право вимагати обміну або повернення товару належної
